...
class StgEtlSettingsRepository:
    def get_setting(self, conn: Connection, etl_key: str,schema: str = 'stg') -> Optional[EtlSetting]:
    ...
    def save_setting(self, conn: Connection, workflow_key: str, workflow_settings: str, schema : str = 'stg') -> None:
